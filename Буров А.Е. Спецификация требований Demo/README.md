...
- Кнопка СОХРАНИТЬ.
  ...
  <table>
    <tr>
     <th><a Title = "Макет страницы профиля" id="BIW-PR-01-example-pr-short_name" href="#">BIW-PR-01-example-pr-short_name</a></th>
    </tr>
    <tr>
     <th><img src="Макет страницы профиля.png" width="460" height="420"  alt="Макет страницы профиля"/></th>
    </tr>
  </table>
