...
<span style= color:red>
  <li> Неверно указан текущий пароль;
  <li> Неверный Email или пароль. Попробуйте еще раз;
  <li> Поле не заполнено;
  <li> Пароли не свопадают. Повторите попытку;
  <li> Новый пароль совпадает с текущим;
  <li> Новый пароль слишком длинный;
  <li> Новый пароль слишком короткий;
  <li> Слишком слабый пароль;
  <li> Пароль не содержит буквы латинского алфавита;
  <li> Пароль не содержит цифры;
  <li> Неверно указан пароль. <u style= color:#0099ff>Забыли пароль?</u>;
</span>
...
<table style="width:100 %">
  <tr>
    <th style="text-align:left;min-width:160 px;width:25 %"><a id="BIW-AC-01" href="#">BIW-AC-01</a></th>
